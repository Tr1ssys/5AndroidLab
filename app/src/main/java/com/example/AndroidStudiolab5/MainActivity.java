...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VoidFunc func = new VoidFunc() {
            @Override
            public void start() {
                BreedInfo repository = BreedInfo.getInstance();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                if(spinner.getSelectedItem() != null) {
                    breedId = BreedInfo.getInstance().getBreedId(spinner.getSelectedItem().toString());
                }
                UrlInfo urlRepository = UrlInfo.createInstance(breedId);
    ...
    public class BreedLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try (Response response = client.newCall(request).execute()) {
                ...
                BreedInfo.createInstance(breeds);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return null;
