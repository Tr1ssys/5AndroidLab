...
public class UrlInfo {
    ...
    private UrlInfo(String breedId) {
        items = new ArrayList<>();
        this.breedId = breedId;
    }

    public static UrlInfo createInstance(String breedId) {
        if(instance == null) {
            instance = new UrlInfo(breedId);
        }
        ...
        protected List<String> doInBackground(String... strings) {
            ...
            OkHttpClient client = new OkHttpClient();
                Request request = new Request.Builder()
                        .addHeader("x-api-key", "2b856eea-2992-4c05-9f1b-0041f7257427")
