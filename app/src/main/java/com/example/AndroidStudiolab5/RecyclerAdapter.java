...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        switch (UrlInfo.getInstance().getLiked(url)) {
            case -1:
                holder.like.setBackgroundColor(Color.WHITE);
                holder.dislike.setBackgroundColor(Color.parseColor("#FFA2A3"));
                break;
            case 0:
                holder.like.setBackgroundColor(Color.WHITE);
                holder.dislike.setBackgroundColor(Color.WHITE);
                break;
            case 1:
                holder.like.setBackgroundColor(Color.parseColor("#D4FAB4"));
                holder.dislike.setBackgroundColor(Color.WHITE);
                break;
        }
        ...
        holder.like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                LikedInfo.createInstance().addUrl(holder.view.getUrl());
            }
        });
        holder.dislike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                LikedInfo.createInstance().deleteUrl(holder.view.getUrl());
            }
        });
    }
